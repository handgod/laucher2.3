...
public class LauncherAppWidgetHostView extends AppWidgetHostView {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (parent instanceof CellLayout) {
            ...
            if (parent instanceof Workspace && !mLauncher.getPaused() && 
                    ((Workspace) parent).getCurrentScreen() == ((Workspace) parent).indexOfChild(layout)) {
                ((Workspace) parent).notifyScreenStateChanged(child, layout, ScreenStateChangeListener.SCREEN_ENTER);
            }
        }
    }
