...
class LauncherSettings {
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        /**
         * The content:// style URL for this temp table
         */
        static final Uri TEMP_CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_TEMP +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");

        /**
         * The content:// style URL for this temp table. When this Uri is used, no notification is
         * sent if the content changes.
         */
        static final Uri TEMP_CONTENT_URI_NO_NOTIFICATION = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_TEMP +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=false");
         ...
         * @return The unique content URL for the specified row.
         */
        static Uri getTempContentUri(long id, boolean notify) {
            return Uri.parse("content://" + LauncherProvider.AUTHORITY +
                    "/" + LauncherProvider.TABLE_TEMP + "/" + id + "?" +
                    LauncherProvider.PARAMETER_NOTIFY + "=" + notify);
        }
        ...
        static final int CONTAINER_PHONE = -200;

        static final int CONTAINER_MESSAGE = -300;
