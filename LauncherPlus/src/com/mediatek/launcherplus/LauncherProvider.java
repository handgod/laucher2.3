...
public class LauncherProvider extends ContentProvider {
    private static final String TAG = "LauncherPlus.LauncherProvider";
    ...
    static final String AUTHORITY = "com.mediatek.launcherplus.settings";
    
    static final String TABLE_FAVORITES = "favorites";
    static final String TABLE_TEMP = "temp";
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
    	private static final int[] LOAD_IN_BOOTING = new int[] {
			R.xml.default_workspace, R.xml.enhancement_workspace
		};
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // - Passion shipped on 2.1 with version 6 of launcherPlus
         ...
         */
        public int loadFavorites(SQLiteDatabase db, int preId) {
            ...
            int i = 0;
            try {
                XmlResourceParser parser = mContext.getResources().getXml(preId);
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
					...
					Boolean gotScene = false;
                    if (name.equals(new String(TAG_SCENE)) && (gotScene == false)) {
                    ...
                    values.clear();                    
                    values.put(LauncherSettings.Favorites.CONTAINER, a.getInteger(
					...
					values.put(LauncherSettings.Favorites.SCENE, sceneOfXml);
					
					Log.e(TAG, a.getString(R.styleable.Favorite_className)+" in screen:"+a.getString(R.styleable.Favorite_screen));
					Log.e(TAG, "x="+ a.getString(R.styleable.Favorite_x)+"  y="+a.getString(R.styleable.Favorite_y));
					Log.e(TAG, "");
        ...
        private boolean addAppShortcut(SQLiteDatabase db, ContentValues values, TypedArray a,
            ...
            try {
            	if (className == null || className.trim().length() == 0){
                	intent = Intent.parseUri(packageName, Intent.FLAG_ACTIVITY_NEW_TASK |
                            Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);
                	if (className == null){
                	    className = "";
                	}
                ...
                values.put(Favorites.TITLE, info != null ? info.loadLabel(packageManager).toString() : className);
