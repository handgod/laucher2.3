...
public class AddAdapter extends BaseAdapter {
    ...
    private final ArrayList<ListItem> mDefaultItems = new ArrayList<ListItem>();
    
    private final ArrayList<ListItem> mShortcutItems = new ArrayList<ListItem>();

    private final ArrayList<ListItem> mWidgetItems = new ArrayList<ListItem>();
    ...
    public AddAdapter(Launcher launcher) {
        ...
        mShortcutItems.add(new ListItem(res, R.string.group_live_folders,
                    R.drawable.ic_launcher_folder, ITEM_LIVE_FOLDER));
        
        mWidgetItems.add(new ListItem(res, R.string.group_widgets,
                R.drawable.ic_launcher_appwidget, ITEM_APPWIDGET));
        
        mDefaultItems.add(new ListItem(res, R.string.group_shortcuts,
                R.drawable.ic_launcher_shortcut, ITEM_SHORTCUT));

        mDefaultItems.add(new ListItem(res, R.string.group_widgets,
                R.drawable.ic_launcher_appwidget, ITEM_APPWIDGET));
        
        mDefaultItems.add(new ListItem(res, R.string.group_live_folders,
                R.drawable.ic_launcher_folder, ITEM_LIVE_FOLDER));
        
        if ( Launcher.isDefStyle() ) {
        	mItems = mDefaultItems;
        } else {
        	if ( Launcher.isShortcutScreen() ) {
        		mItems = mShortcutItems;
        	} else {
        		mItems = mWidgetItems;
        	}
        }
