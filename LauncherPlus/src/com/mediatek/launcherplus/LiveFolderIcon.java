...
public class LiveFolderIcon extends FolderIcon {
	private Bitmap mLiveFolderIconBitmap;
	private Bitmap mLiveFolderIconEditBitmap;
    ...
    static LiveFolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        if (!Launcher.isDefStyle()) {
        	icon.mLiveFolderIconEditBitmap = icon.mLiveFolderIconBitmap = IconCache.createCompoundBitmap(icon.getContext(), icon.mIconBackground, b, false);          
        	icon.mLiveFolderIconEditBitmap = IconCache.createCompoundBitmap(icon.getContext(), icon.mLiveFolderIconBitmap, launcher.mIconEditBg, false);
            icon.setCompoundDrawablesWithIntrinsicBounds(null, new FastBitmapDrawable(icon.mLiveFolderIconBitmap), null, null);
        } else {
    ...
    public Bitmap getIconBitmap() {
    	return mLiveFolderIconBitmap;
    }
    
    public Bitmap getIconEditBitmap() {
    	return mLiveFolderIconEditBitmap;
    }
}
